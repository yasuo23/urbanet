                                    ...
                                    <v-col col="6">
                                        <v-carousel height="400px" style="width: 350px;">
                                            <v-carousel-item v-for="im in anomaly.images" :key="im"
                                                :src="im" width="100%"></v-carousel-item>
                                        </v-carousel>
                                    </v-col>
                                </v-container>
                            </v-card-text>
        ...
        headers() {
            return [
                ...
                },
                {
                    ...
                    filter: value => {
                        return this.activeFilters.commune ? this.activeFilters.commune.includes(value) : true;
                    }
                },
    ...
    methods: {
        ...
        async getAnomalies() {
            ...
            if (error) {
                ...
                //get the description of the anomaly from multmedia table
