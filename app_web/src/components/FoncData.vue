                            ...
                            <v-card-text>
                                <v-container>
                                    <v-col>
                                        ...
                                        <v-row>
                                            <!-- <div class="img" v-for="im in anomaly.images" :key="im">
                                                <img style="width: 400px; height: 400px;" :src="im" alt="">
                                            </div> -->
                                            <v-carousel >
                                                <v-carousel-item v-for="im in anomaly.images" :key="im"
                                                    :src="im"></v-carousel-item>
                                            </v-carousel>
                                        </v-row>
                                    </v-col>
                                </v-container>
...
export default {
    ...
    mounted() {
        this.getUser();
        //do a settimeout for 3 seconds to get the anomalies
        setTimeout(() => {
            this.getAnomalies();
        }, 3000);
